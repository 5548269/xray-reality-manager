...
This roadmap describes intended work, not guaranteed delivery dates. Priorities may change based on testing and user feedback.

本路线图记录计划中的工作，不代表确定的交付日期。优先级可能根据测试结果和用户反馈调整。
...
进展应通过公开 Issue 和关联 Pull Request 跟踪，使已完成的工作保持真实、可验证。
